        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6">
              Your trusted destination for premium luxury vehicles. Experience
              excellence in every drive.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-charcoal-light rounded-lg flex items-center justify-center hover:bg-gold/20 hover:text-gold transition-colors"
              >
